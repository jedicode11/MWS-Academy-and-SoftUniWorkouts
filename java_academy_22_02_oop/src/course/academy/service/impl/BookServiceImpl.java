...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Book getBookById(Long id) throws NoneexistingEntityException {
    ...
    @Override
    public Book updateBook(Book book) throws NoneexistingEntityException, InvalidEntityDataException {
        try {
            bookValidator.validate(book);
        } catch (ConstraintViolationException ex) {
            throw new InvalidEntityDataException(
    ...
    @Override
    public Book deleteBookById(Long id) throws NoneexistingEntityException {
